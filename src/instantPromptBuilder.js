...
function buildPromptOperationalContext(operationalContext = {}) {
  ...
  return {
    ...
    dashboardState: {
      ...
      hasProtocolLinkedToActiveLot: dashboardState.hasProtocolLinkedToActiveLot === true,
      latestLotProtocolId: dashboardState.latestLotProtocolId || null,
      selectedLotProtocolId: dashboardState.selectedLotProtocolId || null,
      activeLotProtocolIdsCount: (dashboardState.activeLotProtocolIds || []).length,
